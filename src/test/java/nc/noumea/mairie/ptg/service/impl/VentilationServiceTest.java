...
public class VentilationServiceTest {
	...
	public void processHSupAndAbsVentilationForWeekAndAgent_HSup() {
		...
		Mockito.when(
				hSupV.processHSup(Mockito.eq(idAgent), Mockito.eq(carr), Mockito.eq(dateLundi),
						Mockito.anyListOf(Pointage.class), Mockito.eq(AgentStatutEnum.CC), Mockito.eq(false), Mockito.eq(ventilDate)))
	...
	public void processHSupAndAbsVentilationForWeekAndAgent_HSup_AgentHasPrime1150() {
		...
		Mockito.when(
				hSupV.processHSup(Mockito.eq(idAgent), Mockito.eq(carr), Mockito.eq(dateLundi),
						Mockito.anyListOf(Pointage.class), Mockito.eq(AgentStatutEnum.CC), Mockito.eq(true), Mockito.eq(ventilDate)))
				.thenReturn(ventilHsup);
	...
	public void showVentilationHistory_Abs() {
		...
		List<VentilDto> result = service.showVentilationHistory(2, 2014, 9005138, RefTypePointageEnum.ABSENCE);
	...
	public void showVentilationHistory_HS() {
		...
		List<VentilDto> result = service.showVentilationHistory(2, 2014, 9005138, RefTypePointageEnum.H_SUP);
