...
public class ApprobationServiceTest {
	...
	public void getPointages_NoFilters_ReturnAllPointagesForGivenPeriod() {
		...
		Mockito.when(pRepo.getListPointages(Mockito.anyList(), Mockito.eq(fromDate), Mockito.eq(toDate), Mockito.eq(idRefType))).thenReturn(Arrays.asList(ptg));
	...
	public void getPointages_EtatFilters_ReturnFilteredPointages() {
		...
		IPointageRepository pRepo = Mockito.mock(IPointageRepository.class);
		Mockito.when(pRepo.getListPointages(Mockito.anyList(), Mockito.eq(fromDate), Mockito.eq(toDate), Mockito.eq(idRefType))).thenReturn(Arrays.asList(ptg, ptg2));
	...
	public void getPointages_PtgWithParent_ReturnNoPointageWithParent() {
		...
		IPointageRepository pRepo = Mockito.mock(IPointageRepository.class);
		Mockito.when(pRepo.getListPointages(Mockito.anyList(), Mockito.eq(fromDate), Mockito.eq(toDate), Mockito.eq(idRefType))).thenReturn(Arrays.asList(ptg2, ptg));
