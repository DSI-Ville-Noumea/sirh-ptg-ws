...
public class DpmServicetTest {
	...
	public void isAgentWithIndemniteForfaitaireTravailSamediDPMInAffectation_true() {
		...
		List<Integer> listNoRubr = Arrays.asList(VentilationPrimeService.INDEMNITE_FORFAITAIRE_TRAVAIL_DPM);
		Mockito.when(sirhWSConsumer.getPrimePointagesByAgent(idAgent, dateJour, dateJour)).thenReturn(listNoRubr);
	...
	@Test
	public void isAgentWithIndemniteForfaitaireTravailDJFDPMInAffectation_false() {
		...
		List<Integer> listNoRubr = Arrays.asList(VentilationPrimeService.INDEMNITE_FORFAITAIRE_TRAVAIL_DPM_DJF);
		Mockito.when(sirhWSConsumer.getPrimePointagesByAgent(idAgent, dateJour, dateJour)).thenReturn(listNoRubr);
	...
	private void isAgentWithIndemniteForfaitaireTravailDPMInAffectation_true(Integer idAgent, Date dateJour) {
		...
		List<Integer> listNoRubr = Arrays.asList(VentilationPrimeService.INDEMNITE_FORFAITAIRE_TRAVAIL_DPM_SAMEDI,
				VentilationPrimeService.INDEMNITE_FORFAITAIRE_TRAVAIL_DPM_DJF, VentilationPrimeService.INDEMNITE_FORFAITAIRE_TRAVAIL_DPM);
		Mockito.when(sirhWSConsumer.getPrimePointagesByAgent(idAgent, dateJour, dateJour)).thenReturn(listNoRubr);
	...
	public void saveIndemniteChoixAgent_update_ok() {
		...
		Mockito.when(dpmRepository.getDpmIndemChoixAgentByAgentAndAnnee(dto.getIdAgent(), dto.getDpmIndemniteAnnee().getAnnee()))
				.thenReturn(choixAgent);
	...
	public void isDroitAgentToIndemniteForfaitaireDPMForOneDay_true() {
		...
		Mockito.when(sirhWSConsumer.isHoliday(date)).thenReturn(true);
	...
	public void calculNombreMinutesRecupereesMajoreesToAgentForOnePointage_noRight() {
		...
		Mockito.when(helperService.calculMinutesPointageInInterval(ptg, new LocalTime(PointageCalculeService.HEURE_JOUR_DEBUT_PRIME_DPM, 0, 0),
				new LocalTime(PointageCalculeService.HEURE_JOUR_FIN_PRIME_DPM, 0, 0))).thenReturn(239);
	...
	public void calculNombreMinutesRecupereesMajoreesToAgentForOnePointage_aucunChoixAgent() {
		...
		Mockito.when(helperService.calculMinutesPointageInInterval(ptg, new LocalTime(PointageCalculeService.HEURE_JOUR_DEBUT_PRIME_DPM, 0, 0),
				new LocalTime(PointageCalculeService.HEURE_JOUR_FIN_PRIME_DPM, 0, 0))).thenReturn(240);
	...
	public void calculNombreMinutesRecupereesMajoreesToAgentForOnePointage_RappelService_pasDroitPrimeDpm() {
		...
		Mockito.when(helperService.getDureeBetweenDateDebutAndDateFin(ptg.getDateDebut(), ptg.getDateFin())).thenReturn(240);
	...
	public void calculNombreMinutesRecupereesMajoreesToAgentForOnePointage_RappelService_moins4h() {
		...
		Mockito.when(helperService.calculMinutesPointageInInterval(ptg, new LocalTime(PointageCalculeService.HEURE_JOUR_DEBUT_PRIME_DPM, 0, 0),
				new LocalTime(PointageCalculeService.HEURE_JOUR_FIN_PRIME_DPM, 0, 0))).thenReturn(120);
