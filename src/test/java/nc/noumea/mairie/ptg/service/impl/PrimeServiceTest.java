...
public class PrimeServiceTest {
	...
	public void getPrimeListForAgent() {
		// Given
		List<RefPrime> result = Mockito.mock(IPointageRepository.class)
				.getRefPrimesListForAgent(AgentStatutEnum.F);
		List<RefPrimeDto> result2 = Mockito.mock(IPrimeService.class)
				.getPrimeListForAgent(AgentStatutEnum.F);
	...
	public void getPrime() {
		...
		Mockito.when(arRepo.getRefPrimesListWithNoRubr(noRubr)).thenReturn(
				listeRefPrime);
