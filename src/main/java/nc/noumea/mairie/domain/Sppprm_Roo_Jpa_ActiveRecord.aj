...
privileged aspect Sppprm_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Sppprm.fieldNames4OrderClauseFilter = java.util.Arrays.asList("id", "nbPrime");
    ...
    public static List<Sppprm> Sppprm.findAllSppprms(String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM Sppprm o";
        ...
        return entityManager().createQuery(jpaQuery, Sppprm.class).getResultList();
    }
    ...
    public static List<Sppprm> Sppprm.findSppprmEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM Sppprm o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
        ...
        return entityManager().createQuery(jpaQuery, Sppprm.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
