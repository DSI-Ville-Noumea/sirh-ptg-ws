...
@RooJavaBean
@RooToString
@RooJpaActiveRecord(persistenceUnit = "ptgPersistenceUnit", identifierColumn = "ID_VENTIL_TASK", identifierField = "idVentilTask", identifierType = Integer.class, table = "PTG_VENTIL_TASK", sequenceName = "PTG_S_VENTIL_TASK")
