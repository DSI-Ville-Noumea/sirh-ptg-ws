...
public class BirtEtatsPayeurWsConsumer implements IBirtEtatsPayeurWsConsumer {
	...
	private static final String FICHE_ETAT_PAYEUR = "ptgEtatsPayeurs.rptdesign";
	...
	public void readAndSaveResponseAsFile(ClientResponse response, Map<String, String> reportParameters, String fileName)
			throws Exception {
	...
	@Override
	public byte[] getFichesEtatsPayeurByStatutAsByteArray(String statut) throws Exception {

		Map<String, String> map = new HashMap<String, String>();
		map.put("statut", statut);

		return getFichesEtatsPayeurAsByteArray(map, FICHE_ETAT_PAYEUR);
	}

	private byte[] getFichesEtatsPayeurAsByteArray(Map<String, String> map, String nomFichier) throws Exception {
	...
	@Override
	public void downloadEtatPayeurByStatut(String statut, String fileName) throws Exception {

		Map<String, String> map = new HashMap<String, String>();
		map.put("statut", statut);

		ClientResponse response = createAndFireRequest(map, FICHE_ETAT_PAYEUR, "PDF");
