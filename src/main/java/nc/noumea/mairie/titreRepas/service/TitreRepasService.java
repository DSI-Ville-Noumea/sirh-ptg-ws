...
public class TitreRepasService implements ITitreRepasService {
	...
	public ReturnMessageDto updateEtatForListTitreRepasDemande(
		...
		if(null == listTitreRepasDemandeDto
				|| listTitreRepasDemandeDto.isEmpty()) {
	...
	protected ReturnMessageDto updateEtatForTitreRepasDemande(Integer idAgentConnecte, TitreRepasDemandeDto dto) {
		...
		// on check l ETAT
		if(null== titreRepasDemande.getCommande() 
				|| !titreRepasDemande.getCommande()) {
