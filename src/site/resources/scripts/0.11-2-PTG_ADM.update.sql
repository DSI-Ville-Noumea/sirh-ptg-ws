...
--UPDATE PTG_REF_PRIME SET IS_CALCULEE = 0 WHERE NORUBR IN (7650, 7651, 7652);
--UPDATE PTG_REF_PRIME set TYPE_SAISIE = 0 WHERE NORUBR IN (7650);
--UPDATE PTG_REF_PRIME set TYPE_SAISIE = 2 WHERE NORUBR IN (7651, 7652);